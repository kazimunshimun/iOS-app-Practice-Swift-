...
class AirlineChooserViewController: UIViewController, HorizontalPickerViewCallBack {
    ...
    override func viewDidLoad() {
        ...
        ticketInfoDataForDeparture = [TicketInfo(airlineName: "American Airlines", ticketClass: "Economy", ticketFrom: newTrip.tripInfo?.from, ticketTo: newTrip.tripInfo?.to, ticketCost: 369, departureDate: newTrip.ticketInfo?.departureDate, returnDate: newTrip.ticketInfo?.returnDate, flightLength: "3h 45m", travelDate: newTrip.ticketInfo?.departureDate),
                                      TicketInfo(airlineName: "Air Canada", ticketClass: "Economy", ticketFrom: newTrip.tripInfo?.from, ticketTo: newTrip.tripInfo?.to, ticketCost: 379, departureDate: "12:45, 21 JUN", returnDate: "15:40, 21 JUN", flightLength: "2h 55m", travelDate: newTrip.ticketInfo?.departureDate),
                          TicketInfo(airlineName: "Alaska Airlines", ticketClass: "Primium Economy", ticketFrom: newTrip.tripInfo?.from, ticketTo: newTrip.tripInfo?.to, ticketCost: 399, departureDate: "18:05, 21 JUN", returnDate: "20:30, 21 JUN", flightLength: "2h 25m", travelDate: newTrip.ticketInfo?.departureDate),
                          TicketInfo(airlineName: "JetBlue Airways", ticketClass: "Buisness", ticketFrom: newTrip.tripInfo?.from, ticketTo: newTrip.tripInfo?.to, ticketCost: 429, departureDate: "10:15, 21 JUN", returnDate: "12:15, 21 JUN", flightLength: "2h 00m", travelDate: newTrip.ticketInfo?.departureDate),
                          TicketInfo(airlineName: "British Airways", ticketClass: "Buisness", ticketFrom: newTrip.tripInfo?.from, ticketTo: newTrip.tripInfo?.to, ticketCost: 449, departureDate: "02:00, 21 JUN", returnDate: "03:45, 21 JUN", flightLength: "1h 45m", travelDate: newTrip.ticketInfo?.departureDate),
                          TicketInfo(airlineName: "Lufthansa", ticketClass: "First", ticketFrom: newTrip.tripInfo?.from, ticketTo: newTrip.tripInfo?.to, ticketCost: 499, departureDate: "10:45, 21 JUN", returnDate: "12:00, 21 JUN", flightLength: "1h 15m", travelDate: newTrip.ticketInfo?.departureDate)]
        ...
        ticketInfoDataForReturn = [TicketInfo(airlineName: "American Airlines", ticketClass: "Economy", ticketFrom: newTrip.tripInfo?.to, ticketTo: newTrip.tripInfo?.from, ticketCost: 369, departureDate: newTrip.ticketInfo?.departureDate, returnDate: newTrip.ticketInfo?.returnDate, flightLength: "3h 05m", travelDate: newTrip.ticketInfo?.returnDate),
                                      TicketInfo(airlineName: "Air Canada", ticketClass: "Economy", ticketFrom: newTrip.tripInfo?.to, ticketTo: newTrip.tripInfo?.from, ticketCost: 379, departureDate: "12:45, 28 JUN", returnDate: "15:40, 28 JUN", flightLength: "2h 25m", travelDate: newTrip.ticketInfo?.returnDate),
                                      TicketInfo(airlineName: "Alaska Airlines", ticketClass: "Primium Economy", ticketFrom: newTrip.tripInfo?.to, ticketTo: newTrip.tripInfo?.from, ticketCost: 399, departureDate: "10:45, 28 JUN", returnDate: "13:05, 28 JUN", flightLength: "2h 20m", travelDate: newTrip.ticketInfo?.returnDate),
                                      TicketInfo(airlineName: "JetBlue Airways", ticketClass: "Buisness", ticketFrom: newTrip.tripInfo?.to, ticketTo: newTrip.tripInfo?.from, ticketCost: 429, departureDate: "01:00, 28 JUN", returnDate: "03:20, 28 JUN", flightLength: "2h 20m", travelDate: newTrip.ticketInfo?.returnDate),
                                      TicketInfo(airlineName: "British Airways", ticketClass: "Buisness", ticketFrom: newTrip.tripInfo?.to, ticketTo: newTrip.tripInfo?.from, ticketCost: 449, departureDate: "08:25, 28 JUN", returnDate: "09:50, 28 JUN", flightLength: "1h 25m", travelDate: newTrip.ticketInfo?.returnDate),
                                      TicketInfo(airlineName: "Lufthansa", ticketClass: "First", ticketFrom: newTrip.tripInfo?.to, ticketTo: newTrip.tripInfo?.from, ticketCost: 499, departureDate: "06:05, 28 JUN", returnDate: "07:40, 28 JUN", flightLength: "1h 35m")]
