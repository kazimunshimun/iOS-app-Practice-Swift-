...
public class Lorem {
    ...
    */
    private static let wordList = [
     "must", "explain", "you", "how", "all", "this", "mistaken", "idea", "denouncing", "praising", "pain", "was", "born", "I", "will", "give", "complete", "account", "the", "system", "expound", "actual", "teachings", "great", "explorer", "truth", "master-builder", "of", "human", "happiness", "one", "rejects", "dislikes","avoids", "itself", "because", "it", "is", "because", "those", "who", "do", "not", "know", "how", "pursue", "pleasure", "rationally", "encounter", "that", "are", "extremely", "painful", "Nor", "again", "there", "anyone", "who", "loves", "pursues", "or", "desires", "to", "obtain", "itself", "because", "but", "because", "occasionally", "circumstances", "occur", "in", "which", "toil", "and", "can", "procure", "him", "some", "great", "take", "trivial", "example", "us", "ever", "undertakes", "laborious", "physical", "exercise", "except", "some", "advantage", "from", "who", "has", "any", "right", "find", "fault", "with", "man", "who", "chooses", "enjoy", "a", "no", "annoying", "consequences", "who", "avoids", "produces", "resultant"]
